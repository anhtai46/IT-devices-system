    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (Map.Entry<Integer, String> brand : brandList.entrySet()) {
                if (search.equals(String.valueOf(brand.getKey())) && value.equals(brand.getValue())) {
                    deviceList = deviceDAO.getListDeviceByBrandID(brand.getKey());
                    break;
                }
            }
            for (Map.Entry<Integer, String> warehouse : warehouseList.entrySet()) {
                if (search.equals(String.valueOf(warehouse.getKey())) && value.equals(warehouse.getValue())) {
            ...
            request.setAttribute("LIST_DETAIL", detailListBasedOnDevice);
            ...
            if (deviceList.size() > 0) {
                ...
                request.setAttribute("LIST_WAREHOUSE", warehouseList);
