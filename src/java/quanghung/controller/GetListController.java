...
public class GetListController extends HttpServlet {
    ...
    private static final String SUCCESS = "createDevice.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Map<Integer, String> warehouse = warehouseDAO.getWarehouse();
            session.setAttribute("LIST_CATEGORY", category);
            session.setAttribute("LIST_WAREHOUSE", warehouse);
            url = SUCCESS;
        } catch (Exception e) {
